...
pub async fn sse_client(app_state: web::Data<AppState>) -> AcumerHttpResponse{
    ...
    (
        ...
        {   
            ...
            let s = match HttpServer::new(move ||{
                ...
                .listen(tcp_listener){ // bind the http server on the passed in tcp listener cause after all http is a tcp based protocol!
                    ...
                    Err(e) => {
                        ...
                        use crate::error::{ErrorKind, ServerError::{ActixWeb, Ws}, AcumerErrorResponse};
                        let error_content = &e.to_string();
                        let error_content = error_content.as_bytes().to_vec();
                        let mut error_instance = AcumerErrorResponse::new(
            ...
            /* 
                ...
                the background loop{}
            */
            // info!("➔ 🎛️ starting acumer on address: [{}:{}]", host, port);
